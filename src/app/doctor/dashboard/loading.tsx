// Covers the page.tsx content area on first load and, more usefully, every
// lateral navigation between the dashboard's tabs (Overview/Availability/
// Schedule/Patients) once the persistent shell (layout.tsx) is already
// mounted -- those switches would otherwise show nothing while the next
// tab's data fetches. Shape mirrors page.tsx's real stat-card grid.
