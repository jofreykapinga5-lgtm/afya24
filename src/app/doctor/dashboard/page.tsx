      ...
      <div className="sticky top-0 z-40 mx-auto mb-3 flex w-full max-w-7xl items-center justify-between rounded-2xl border border-[#dfe8eb] bg-white/94 px-4 py-3 shadow-[0_18px_45px_-32px_rgba(8,50,115,0.35)] backdrop-blur lg:hidden">
        ...
        <details className="group relative">
          <summary className="flex size-10 cursor-pointer list-none items-center justify-center rounded-full bg-[#e8f7f4] text-[#083273] outline-none transition hover:bg-[#d8f3ef] focus-visible:ring-3 focus-visible:ring-[#01b7bb]/30">
            ...
            <span className="sr-only">Open doctor menu</span>
          </summary>
            ...
            <div className="grid gap-4">
              ...
              <section id="availability" className="rounded-[1.35rem] bg-white p-5 shadow-[0_14px_40px_-35px_rgba(8,50,115,0.65)] ring-1 ring-[#dfe8eb]">
                ...
                {canManageAvailability ? (
                  <form action={updateProviderAvailability} className="mt-5 grid gap-4">
                    <label className="flex items-center justify-between gap-3 rounded-2xl bg-[#f8fbfd] p-4 text-sm ring-1 ring-[#dfe8eb]">
                      ...
                      <input
                        ...
                        defaultChecked={Boolean(provider?.available_now)}
                        name="availableNow"
                        type="checkbox"
                      />
                    </label>
                    ...
                    <label className="grid gap-1.5 text-sm">
                      ...
                      <Textarea
                        ...
                        defaultValue={provider?.availability_note ?? ""}
