...
const dict = {
  ...
  account_phone_hint_placeholder: {
    en: "Phone number (e.g. 0712345678)",
    sw: "Nambari ya simu (mfano 0712345678)",
  },
  account_phone_hint_title: {
    en: "Enter your phone number, e.g. 0712345678 or +255712345678",
    sw: "Weka nambari yako ya simu, mfano 0712345678 au +255712345678",
  },
  ...
  doctor_forgot_password_link: { en: "Forgot password?", sw: "Umesahau nenosiri?" },
  doctor_forgot_password_title: { en: "Reset your password", sw: "Weka upya nenosiri lako" },
  doctor_forgot_password_body: {
    en: "Enter your staff email and we'll send you a link to set a new password.",
    sw: "Weka barua pepe yako ya kazi na tutakutumia kiungo cha kuweka nenosiri jipya.",
  },
  doctor_forgot_password_cta: { en: "Send reset link", sw: "Tuma kiungo cha kuweka upya" },
  doctor_forgot_password_sent: {
    en: "If that email belongs to a staff account, a reset link is on its way. Check your inbox.",
    sw: "Ikiwa barua pepe hiyo ni ya akaunti ya kazi, kiungo cha kuweka upya kinakuja. Angalia barua pepe yako.",
  },
  doctor_forgot_password_back: { en: "Back to sign in", sw: "Rudi kuingia" },
  doctor_reset_password_title: { en: "Set a new password", sw: "Weka nenosiri jipya" },
  doctor_reset_password_new_label: { en: "New password", sw: "Nenosiri jipya" },
  doctor_reset_password_confirm_label: { en: "Confirm new password", sw: "Thibitisha nenosiri jipya" },
  doctor_reset_password_cta: { en: "Set new password", sw: "Weka nenosiri jipya" },
  doctor_reset_password_success: {
    en: "Password updated. Sign in with your new password.",
    sw: "Nenosiri limesasishwa. Ingia kwa nenosiri jipya.",
  },
  error_passwords_dont_match: { en: "Passwords don't match.", sw: "Manenosiri hayafanani." },
  ...
  video_feedback_title: { en: "How was your visit?", sw: "Ulipataje huduma?" },
  video_feedback_body: {
    en: "Your rating and feedback help us improve care quality.",
    sw: "Ukadiriaji na maoni yako yanatusaidia kuboresha huduma.",
  },
  video_feedback_rating_label: { en: "Star rating", sw: "Kiwango cha nyota" },
  video_feedback_star_option: { en: "{n} stars", sw: "Nyota {n}" },
  video_feedback_private_label: { en: "Feedback for our team (private)", sw: "Maoni kwa timu yetu (ya faragha)" },
  video_feedback_private_placeholder: {
    en: "What went well, what could be better…",
    sw: "Nini kilienda vizuri, nini kingeweza kuwa bora…",
  },
  video_feedback_testimonial_label: {
    en: "Share a short testimonial (optional)",
    sw: "Andika ushuhuda mfupi (hiari)",
  },
  video_feedback_testimonial_placeholder: {
    en: "What would you tell a friend considering Afya24?",
    sw: "Ungemwambia nini rafiki anayefikiria kutumia Afya24?",
  },
  video_feedback_consent_label: {
    en: "Afya24 may feature this testimonial publicly (e.g. on the website).",
    sw: "Afya24 inaweza kuonyesha ushuhuda huu hadharani (mfano, kwenye tovuti).",
  },
  video_feedback_rating_required: { en: "Please choose a star rating.", sw: "Tafadhali chagua kiwango cha nyota." },
  video_feedback_submit: { en: "Submit feedback", sw: "Tuma maoni" },
  video_feedback_skip: { en: "Skip for now", sw: "Ruka kwa sasa" },
  video_feedback_thanks_title: { en: "Thank you for your feedback.", sw: "Asante kwa maoni yako." },
  video_feedback_continue: { en: "Continue", sw: "Endelea" },
  ...
  admin_feedback_subtitle: {
    en: "Star ratings, private feedback, and opt-in public testimonials from patients after their consultation.",
    sw: "Ukadiriaji wa nyota, maoni ya faragha, na ushuhuda wa hiari kutoka kwa wagonjwa baada ya matibabu.",
  },
  admin_feedback_average: { en: "Average rating", sw: "Wastani wa ukadiriaji" },
  admin_feedback_total: { en: "Total submissions", sw: "Jumla ya maoni yaliyotumwa" },
  admin_feedback_empty: { en: "No patient feedback yet.", sw: "Hakuna maoni ya wagonjwa bado." },
  admin_feedback_private_label: { en: "Private feedback", sw: "Maoni ya faragha" },
  admin_feedback_testimonial_label: { en: "Testimonial", sw: "Ushuhuda" },
  admin_feedback_consent_public: { en: "OK to feature publicly", sw: "Inaruhusiwa kuonyeshwa hadharani" },
  admin_feedback_consent_private: { en: "Private only", sw: "Faragha tu" },
